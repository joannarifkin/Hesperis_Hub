...
#SBATCH --job-name=Trinity_Rifkin_Hesperis_flower
...
#SBATCH --output=Trinity_floral-%A-%a.log
#SBATCH --array=1-10%2
...
file=$(ls /nfs/turbo/rsbaucom/lab/Hesperis_transcriptome_assemblies_2022/Trim_galore_floral/*R1_trimmed.fq.gz | sed -n ${SLURM_ARRAY_TASK_ID}p)
echo $file
printf "\n"
